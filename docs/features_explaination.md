...
The gather tab allows you to enable up to 5 fields for the macro to gather in. The gather settings are the same as natro macro, so the settings should work the same
...
_Note: North is the direction where the player faces mountain top_
